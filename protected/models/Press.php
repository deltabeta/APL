...
class Press extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array(', list_id, press_subject, press_content, , , , , , press_sender_name, press_sender_email, press_replyto_name, press_replyto_email, , , , , , , ', 'required'),
	...
	public function search()
	{
		...
		$criteria->compare('press_file_1',$this->press_file_1,true);
		$criteria->compare('press_file_2',$this->press_file_2,true);
		$criteria->compare('press_file_3',$this->press_file_3,true);
